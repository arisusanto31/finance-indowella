<x-app-layout>
    ...
    <div class="card shadow-sm mb-4">
        <h5 class="text-primary-dark card-header" style="padding-bottom:0px;"> 💳 <strong>KARTU BAHAN JADI</strong>
    ...
    @push('scripts')
        <script>
            ...
            function getMutasiMasuk() {
                page = "masuk";
                $.ajax({
                    url: "{{ route('kartu-bahan-jadi.get-mutasi-masuk') }}?month={{ $month }}&year={{ $year }}",
                    method: "GET",
                    success: function(res) {
                        console.log(res);
                        if (res.status == 1) {
            ...
            function linkJournal() {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        "model_id": model_id,
                        "journal_id": id,
                        "model": "App\\Models\\KartuBahanJadi",
                    },
                    success: function(res) {
                        console.log(res);
                        if (res.status == 1) {
            ...
            function getMutasiKeluar() {
                $.ajax({
                    url: "{{ route('kartu-bahan-jadi.get-mutasi-keluar') }}?month={{ $month }}&year={{ $year }}",
                    method: "GET",
                    success: function(res) {
                        console.log(res);
                        if (res.status == 1) {
