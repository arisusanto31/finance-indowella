                ...
                <div class="col-md-3 col-xs-6">
                    <select class="form-control" id="year-select" onchange="location = this.value;">
                        @for ($y = date('Y'); $y >= 2020; $y--)
                            <option value="{{ route('aset-tetap.index', ['year' => $y]) }}"
                                {{ $year == $y ? 'selected' : '' }}>Tahun {{ $y }}</option>
                        @endfor
                    </select>
                </div>
            </div>
                    ...
                    <div class="nav-align-top mb-4">
                        ...
                        <div class="tab-content" style="background-color: #f8f9fa;">
                            <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel">
                                <div class="row mt-1">
                                    <div class="col-md-2">
                                        <button type="button" class=" btn-primary" onclick="showModalInventory()"> 🔃
                                            buat inventory</button>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="navs-pills-top-messages" role="tabpanel">
                                <div class="row mt-1">
                                    <div class="col-md-2">
                                        <button type="button" class=" btn-primary" onclick="showModalKartuInventory()">
                                            🔃 buat kartu</button>
                                    </div>
                                </div>
