<x-app-layout>
    ...
    <div class="card shadow-sm mb-4">
        <h5 class="text-primary-dark card-header" style="padding-bottom:0px;"> 💳 <strong>KARTU BAHAN JADI</strong> </h5>
        <div class="card-body">
    ...
    <script>
        ...
        function getMutasiMasuk() {
            page = "masuk";
            $.ajax({
                url: "{{ route('kartu-bahan-jadi.get-mutasi-masuk') }}",
                method: "GET",
                success: function(res) {
                    console.log(res);
                    if (res.status == 1) {
        ...
        function getMutasiKeluar() {
            $.ajax({
                url: "{{ route('kartu-bahan-jadi.get-mutasi-keluar') }}",
                method: "GET",
                success: function(res) {
                    console.log(res);
                    if (res.status == 1) {
