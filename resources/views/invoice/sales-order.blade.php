<x-app-layout>
                                    ...
                                    @if ($index === 0)
                                        <td class="" rowspan="{{ $rowspan }}">
                                            ...
                                            @if ($item->parent->total_ppn_k > 0)
                                                ...
                                                <div class="mt-10" style="background-color:#bbb; height:1px; width:100%;"></div>
                                                <strong>Rp{{ format_price($item->parent->total_price + $item->parent->total_ppn_k) }}</strong>
                                            @endif
    ...
    @push('scripts')
        <script>
            ...
            trashSO= <?php echo json_encode($trashSO); ?>;
            console.log('trashSO:', trashSO);
