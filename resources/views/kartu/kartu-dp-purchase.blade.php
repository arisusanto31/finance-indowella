<x-app-layout>
    <div class="card shadow-sm mb-4">
        <h5 class="text-primary-dark card-header" style="padding-bottom:0px;"> 💳 <strong>KARTU DP PURCHASE</strong>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="flex-column align-items-start">
                        <h5 class="modal-title" id="exampleModalLabel1">Buat Kartu DP Purchase</h5>
    ...
    <div class="modal fade" id="pelunasanModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="flex-column align-items-start">
                        <h5 class="modal-title" id="exampleModalLabel1">Buat Pelunasan Kartu DP Purchase</h5>
                            ...
                            res.msg.forEach(function(data, i) {
                                ...
                                <tr>
                                    ...
                                    <td class="textright">${formatRupiah(saldoAkhir)}</td>      
                                      <td>
                                        <button type="button" class="btn btn-primary btn-sm" onclick="showDetailKartu('${data.invoice_pack_number}')"><i class="fas fa-eye"></i> detail</button>
                                    </td>                          
                                </tr>
                            `;
                            });
