...
Schedule::command('app:fix-problem-saldo 1')->cron('*/21 * * * *');
Schedule::command('app:fix-problem-saldo 2')->cron('*/19 * * * *');
Schedule::command('app:recalculate-kartu-stock-request')->cron('*/17 * * * *');
