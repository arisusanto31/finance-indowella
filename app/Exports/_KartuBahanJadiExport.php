...
class _KartuBahanJadiExport implements FromCollection, WithEvents, WithTitle, WithColumnWidths
{
    /**
    ...
    public function collection()
    {
        ...
        $fixData[] = [
            "Total Saldo Awal",
            format_price($globalSaldoAwal)
        ];
        $fixData[] = [
            "Total Mutasi Masuk",
            format_price($globalMutasiMasuk)
        ];
        $fixData[] = [
            "Total Mutasi Keluar",
            format_price($globalMutasiKeluar)
        ];
        $fixData[] = [
            "Total Saldo Akhir",
            format_price($globalSaldoAkhir)
        ];
    ...
    {
        return 'K.Brg Jadi ' . $this->data['year'] . '-' . $this->data['month'];
    }
